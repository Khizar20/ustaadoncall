...
export const coreTranslations: TranslationKey = {
  ...
  "Sign in to your ThoseJobs.com account": { en: "Sign in to your ThoseJobs.com account", ur: "اپنے ThoseJobs.com اکاؤنٹ میں سائن ان کریں" },
  ...
  "Provider Login": { en: "Worker Login", ur: "ورکر لاگ ان" },
  "Worker Login": { en: "Worker Login", ur: "ورکر لاگ ان" },
  ...
  "Join thousands of professionals who've grown their income with ThoseJobs.com": { en: "Join thousands of professionals who've grown their income with ThoseJobs.com", ur: "ہزاروں پیشہ ور افراد میں شامل ہوں جنہوں نے ThoseJobs.com کے ساتھ اپنی آمدنی بڑھائی ہے" },
  "Start Your Application": { en: "Start Your Application", ur: "اپنی درخواست شروع کریں" },
  "Learn More": { en: "Learn More", ur: "مزید جانیں" },
  "Why Choose ThoseJobs.com?": { en: "Why Choose ThoseJobs.com?", ur: "ThoseJobs.com کیوں منتخب کریں؟" },
